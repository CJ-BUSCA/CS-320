...
class AppointmentServiceTest {
	...
	void setUp() {
		...
		tooLongDescription ="This description far exceeds the appointment description requirements.";
		pastDate = new Date(0);
	}
	@Test
	void testNewAppointment() {
		...
		assertNotEquals(service.getAppointmentList().get(0).getAppointmentId(), service.getAppointmentList().get(1).getAppointmentId()); assertNotEquals(service.getAppointmentList().get(0).getAppointmentId(),
